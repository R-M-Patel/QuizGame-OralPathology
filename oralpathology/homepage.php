  ...
  <script>
   ...
   $(window).load(function(){
    ...
    <div class="row">
      ...
      <div class="col-sm-6 col-xs-12">
        <button class="home-btn gray" onclick="window.location.href='quiz.php';" > QUIZ </button>
        <button class="home-btn gray" onclick="window.location.href='scorecard.php';" > GAME SCORECARD </button>
        <button class="home-btn gray" onclick="window.location.href='quizscorecard.php';" > QUIZ SCORECARD </button>

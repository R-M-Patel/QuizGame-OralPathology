...
//session_start();
//$qid = $_SESSION['upload_question_id'];
$qid = filter_input(INPUT_POST, "upload_qid");
//echo $qid;

// Check if the question id is got
if (!$qid || strlen($qid) == 0) {
//    echo "Didn't get the question id";
	...
	<div class='row-fluid'>
		<div class='span12'>
			<div class='alert'>
				...
				<h4>
					Warning!
				</h4> <strong>Warning!</strong> Didn't get the question id!
			</div>
		</div>
	</div>
</div>";
